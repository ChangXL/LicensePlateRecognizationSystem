...
if __name__ == '__main__':
    cur_dir = sys.path[0]
    data_dir = os.path.join(cur_dir, 'dataset_na/train')
    test_dir = os.path.join(cur_dir, 'dataset_na/test')
    train_model_path = os.path.join(cur_dir, './model_na/model.ckpt')
    model_path = os.path.join(cur_dir,'./model_na/model.ckpt-510')
